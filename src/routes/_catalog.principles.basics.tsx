...
export const Route = createFileRoute("/_catalog/principles/basics")({
  ...
  return (
    <div className="mx-auto w-full max-w-4xl space-y-12 px-4 py-12 md:px-8">
      ...
      <section className="space-y-4">
        <h2 className="text-lg font-semibold">近接 — 関係の近さは距離で表す</h2>
        ...
        <p className="text-xs leading-relaxed text-muted-foreground">
          職種名と会社名は2pxでひとつの塊、メタ情報同士は8px、塊と塊の間は16px。アイコンとラベルは2pxで「1語」として読める。区切り線は1本も使っていない。
        </p>
      </section>

      <section className="space-y-4">
        <h2 className="text-lg font-semibold">整列 — 見えない線を1本に</h2>
        <p className="text-sm leading-relaxed text-muted-foreground">
      ...
      <section className="space-y-4">
        <h2 className="text-lg font-semibold">反復 — 同じ役割は同じ形</h2>
        <p className="text-sm leading-relaxed text-muted-foreground">
      ...
      <section className="space-y-4">
        <h2 className="text-lg font-semibold">対比 — 重要度の差をはっきりつける</h2>
        <p className="text-sm leading-relaxed text-muted-foreground">
        ...
        <p className="text-xs leading-relaxed text-muted-foreground">
          主情報は 24px の太字、補足は 12px のグレー。ボタンも primary と ghost
