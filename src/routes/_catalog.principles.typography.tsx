...
export const Route = createFileRoute("/_catalog/principles/typography")({
  ...
  return (
    <div className="mx-auto w-full max-w-4xl space-y-12 px-4 py-12 md:px-8">
      ...
      <section className="space-y-4">
        <h2 className="text-lg font-semibold">タイプスケール</h2>
        <div
        ...
        <p className="text-sm leading-relaxed text-muted-foreground">
          UI の基本は text-sm(14px)。text-xl と text-3xl
          以上は原則使わず、5段で完結させる。書体は増やさず、italic は日本語で崩れるため使わない。
        </p>
      </section>

      <section className="space-y-4">
        <h2 className="text-lg font-semibold">ウェイト</h2>
        <div
          style={sampleCanvasStyle}
      ...
      <section className="space-y-4">
        <h2 className="text-lg font-semibold">トーン&ボイス</h2>
        <p className="text-sm leading-relaxed text-muted-foreground">
