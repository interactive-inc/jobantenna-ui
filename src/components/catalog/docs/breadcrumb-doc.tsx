...
export const breadcrumbDoc: ComponentDoc = {
  ...
  category: "ナビゲーション",
  purpose:
    "現在のページがサイト階層のどこにあるかを示し、上位階層へワンクリックで戻れるようにするナビゲーションです。ジョブアンテナでは「求人を探す > 職種 > 営業・企画営業」のような検索条件のドリルダウンや、求人詳細・管理画面での現在地表示に使います。最後の項目は BreadcrumbPage でリンクなしの現在地として示します。",
  patterns: [
    {
      id: "basic",
      title: "基本",
