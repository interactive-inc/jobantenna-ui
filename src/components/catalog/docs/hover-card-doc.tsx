...
export const hoverCardDoc: ComponentDoc = {
  ...
  category: "オーバーレイ",
  purpose:
    "リンクやテキストにホバーしたとき、遷移せずに参照先のプレビューを浮かせて見せるカードです。クリックする前に相手の概要を確認できるので、一覧を離れたくない場面に向きます。ジョブアンテナでは求人カードの企業名から企業プレビューを、管理画面の応募者テーブルから候補者プロフィールを覗く用途に使います。",
  patterns: [
    {
      id: "basic",
      title: "基本",
      description:
        "Trigger と Content だけの最小構成です。企業名リンクにホバーすると社名・紹介文・所在地の簡単なプレビューが開きます。",
      previewHeight: null,
      Demo: BasicPattern,
    },
    {
      ...
      title: "企業プレビュー",
      description:
        "求人詳細の文中に置いた企業名から、ロゴ・業種・所在地・アンテナレベルとフォローボタンをまとめた企業カードを表示します。ページを離れずに企業をチェックしてもらう場面に向いています。",
      previewHeight: 400,
    ...
    },
    {
      ...
      title: "候補者プレビュー",
      description:
        "管理画面の応募者テーブルで候補者名にホバーすると、アバター・年齢・前職・応募求人・ステータスバッジを確認できます。行を開かずに候補者を素早く見比べたいときに使います。",
      previewHeight: 400,
