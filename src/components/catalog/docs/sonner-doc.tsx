...
export const sonnerDoc: ComponentDoc = {
  ...
  category: "フィードバック",
  purpose:
    "操作の結果を画面の隅に一時的に表示するトースト通知コンポーネント。Toaster を1つ配置し、イベントハンドラから toast() 関数を呼んで発火する。jobantenna では応募完了やいいかも！送信の確認、管理画面での保存・削除の結果通知など、ユーザーの操作を妨げずに伝えたいフィードバックに使う。",
  patterns: [
    {
      id: "basic",
      title: "基本",
